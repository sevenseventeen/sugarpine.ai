// data.js — Sugarpine content. "today" anchored to June 2026.
...
export const TOPICS = [
  ...
  },
  {
    ...
    cards: [
      ...
      { title: "Lovable / v0 / Bolt", body: "Describe an app in plain language and get a working web app back. These are for founders and non-engineers shipping a prototype or landing page fast.", note: "Best for non-technical builders and quick MVPs." },
    ],
...
export const ALL = [...PRIMER, ...TOPICS];
export const byId = (id) => ALL.find((p) => p.id === id);
export const recent = [...ALL].sort((a, b) => new Date(b.updated) - new Date(a.updated));
